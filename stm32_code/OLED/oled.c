...
/*******************************************************************
 * @name       :void OLED_WR_Byte(unsigned char dat,unsigned char cmd)
...
void OLED_WR_Byte(unsigned char dat,unsigned char cmd)
{
	if (cmd == OLED_CMD)
	{
		HAL_I2C_Mem_Write(&hi2c1, IIC_ADDRESS, OLED_IIC_CMD_RAM_ADDR, I2C_MEMADD_SIZE_8BIT, &dat, 1, 100);
	}
	else if (cmd == OLED_DATA)
	{
		HAL_I2C_Mem_Write(&hi2c1, IIC_ADDRESS, OLED_IIC_DATA_RAM_ADDR, I2C_MEMADD_SIZE_8BIT, &dat, 1, 100);
	}
}
